...
T_model=interp1(z,T,z_data,'spline'); %interp function takes the z,T model values and then fits a modeled T to each z_data (observed data)

%--chi squared test

F=sum((T_model-T_data).^2);
